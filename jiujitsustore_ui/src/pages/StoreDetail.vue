					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateStore()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Stores = true">Add</base-button>
								              <modal :show.sync="modal2Stores">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Store Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="StoreId" type="text" placeholder="Enter StoreId" v-model="storeDetails.storeId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Name" type="text" placeholder="Enter Name" v-model="storeDetails.name"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Location</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Location" type="text" placeholder="Enter Location" v-model="storeDetails.location"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async handleAddSubmitted() {
      this.modal2Stores = false;

      const jsonData = JSON.stringify(this.storeToAdd);
      console.log(jsonData);
      
      const res = await StoreService.addStore(jsonData);
    ...
    async updateStore() {
      ...
      const jsonData = JSON.stringify(this.storeDetails);
      const res = await StoreService.update(jsonData);
...
//        this.getAllStores();
    ...
    async getStoreDetails() {
      try {
			let response = await StoreService.get(this.storeId);
