...
<template>
        ...
        <card>
          <template slot="header">
            <div class="row justify-content-between align-items-between mx-3">
              ...
              <div>
                  <base-button class="btn btn-primary" @click="modalSuppliers = true">Add</base-button>
              </div>
              
              <modal :show.sync="modalSuppliers">
                <template slot="header">
  ...
  <base-input label="SupplierId" type="text" placeholder="Enter SupplierId" v-model="supplierToAdd.supplierId"></base-input>
          ...
          <div v-if="isTableView">
            ...
            <a-table :columns="columns" :data-source="suppliers" :row-key="record => record.SupplierId" :pagination="pagination"
          ...
          <div v-else>
            ...
            <SupplierPictureView :suppliers="suppliers" />
          </div>
...
import SupplierPictureView from './SupplierPictureView.vue';
...
export default {
  ...
  data() {
    return {
      ...
      sortBy: 'supplierId',           // Column to sort by
  ...
  methods: {
    ...
    async renderSuppliersTable() {
      ...
      let suppliersTableData = [];
      for (let i = 0; i < this.suppliers.length; i++) {
        suppliersTableData.push({
          id: i,
          supplierId: this.suppliers[i].supplierId,
          year: this.suppliers[i].year,
          date: this.suppliers[i].date,
          competitionId: this.suppliers[i].competitionId,
          supplierId: this.suppliers[i].supplierId,
        });
    ...
    async onTableChange(pagination, filters, sorter) {
	  ...
	  this.$emit('get-all-suppliers',this.sortBy,this.sortOrder,this.pagination.current-1,this.pagination.pageSize);
    ...
    handleSearchQueryChanged() {
    	...
    	this.$root.$emit('searchQueryForSuppliersChanged', this.searchQuery);
	...
	async handleAddSubmitted() {
      ...
      this.supplierToAdd.created = currentDate;
